...
namespace {
    ...
    class Authority extends \mnshankar\RoleBasedAuthority\Facades\Authority{
         ...
         * @return array|\Authority\Rule 
         * @static 
         */
        public static function allow($actions, $resource, $condition = null){
            return \Authority\Authority::allow($actions, $resource, $condition);
        }
         ...
         * @static 
         */
        public static function deny($actions, $resource, $condition = null){
            return \Authority\Authority::deny($actions, $resource, $condition);
        }
         ...
         * @static 
         */
        public static function addRule($allow, $actions, $resource, $condition = null){
            return \Authority\Authority::addRule($allow, $actions, $resource, $condition);
        }
