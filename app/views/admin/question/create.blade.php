...
<div class="row">
        <div class="col-sm-12">
            <h3><a href="{{URL::route(question)}}">Quản lý tin tức</a> » Thêm mới </h3>

            {{ Form::open(array('route'=>array(question),'class'=>'form-horizontal form-top-margin','role'=>'form','method'=>'POST','style'=>'margin-top: 15px;')) }}
                <div class="form-group {{ $errors->has('title')? 'has-error':'' }}">
                        <label for="title" class="col-lg-2 control-label">Tiêu đề(*)</label>
                        <div class="col-lg-10">
                            {{ Form::text('title', Input::old('title'), array('id'=>'title','class' => 'form-control', 'placeholder' => 'Nhập tiêu đề')) }}
                            @if($errors->has('title'))
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::textarea('description', Input::old('description'), array('class' => 'form-control', 'placeholder' => 'Nhập mô tả','style'=>'height:60px')) }}
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::text('keyword', Input::old('keyword'), array('class' => 'form-control', 'placeholder' => 'Nhập các từ khóa (cách nhau bởi dấu phẩy)')) }}
                        </div>
                </div>
                {{-- Tags --}}
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text( "tags" , Input::old( "tags" ) , array('data-role'=>'tagsinput',  'class'=>'form-control' , 'placeholder'=>'Nhập các tag' ) ) }}
                    </div>
                    ...
                    <div class="col-lg-5">
                        <span class="file-input">
                            <div class="file-preview ">
                                    ...
                                    <div class="file-preview-thumbnails">
                                        ...
                                        <div data-fileindex="init_1" id="preview-1421999232147-init_1" class="file-preview-frame file-preview-initial">
                                           <img id="imgTopic" title="The Earth" alt="The Earth" class="file-preview-image" src="{{Input::old('image')!=""? Input::old('image'): Asset('assets/libs/bootstrap-fileinput/img/none.gif') }}">
                            ...
                            <div class="input-group  {{ $errors->has('image')? 'has-error':'' }}">
                                ...
                                {{ Form::text('image', Input::old('image'), array('id'=>'spnFileName','class' => 'form-control', 'placeholder' => 'Chọn ảnh đại diện')) }}
                        ...
                        <span class="file-input">
                            <div class="file-preview ">
                                    ...
                                    <div class="file-preview-thumbnails">
                                        ...
                                        <div data-fileindex="init_1" id="preview-1421999232147-init_1" class="file-preview-frame file-preview-initial">
                                           <img id="imgThumb" title="The Earth" alt="The Earth" class="file-preview-image"  src="{{Input::old('thumbnail')!=""? Input::old('thumbnail'): Asset('assets/libs/bootstrap-fileinput/img/none.gif') }}">
                            ...
                            <div class="input-group {{ $errors->has('thumbnail')? 'has-error':'' }}  ">
                                {{ Form::text('thumbnail', Input::old('thumbnail'), array('id'=>'spnThumbFileName','class' => 'form-control', 'placeholder' => 'Chọn ảnh thubnail')) }}
                ...
                <div class="form-group {{ $errors->has('idnewscategories')? 'has-error':'' }}">
                    ...
                    <div class="col-lg-10">
                        ...
                        @endif
                        <script>$("#cboSubCategory").val("{{Input::old('idnewscategories')}}");</script>
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            ...
                            {{Form::checkbox('status', '1', Input::old('status', true),array('style'=>'margin:10px 0 0 0')) }}
